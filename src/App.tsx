...
import { editorPanelLayoutAtom, editorTextSelectionAtom, hoveredDiffIndexAtom, syncModeAtom, visibleDiffsAtom } from './states/atoms'
...
//import ResizableSidebar from './components/AppSidebar/ResizableSidebar';
...
function App() {
    ...
    <table width="1000" style="width:1000px">
  <tr>
		...
		<div>
			<div className={clsx(styles.appLayout)}>
				<ResizablePanelGroup direction='horizontal'>
					<ResizablePanel minSize={400} key="main" >
						<EditorPanel />
					</ResizablePanel>
					{/* <ResizableHandle /> */}
					<ResizablePanel minSize={170} key="side" initialSize="250px">
						<AppSidebar />
						{/* <ResizableSidebar
							panels={[
								{ id: "a", title: "A · Logs", render: () => filler("A") },
								{ id: "b", title: "B · Outline", render: () => filler("B") },
								{ id: "c", title: "C · Inspect", render: () => filler("C") },
							]}
						/> */}
					</ResizablePanel>
				</ResizablePanelGroup >
