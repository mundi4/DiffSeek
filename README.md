...
- [사용해보기](https://mundi4.github.io/DiffSeek/)
- [코드](https://github.com/mundi4/DiffSeek)
...
- 이렇게 강제로 양쪽에서 대응되는 부분의 Y좌표를 강제로 맞추고 전체 문서의 높이까지 맞춰주면 스크롤 동기화는 그냥 양쪽의 `scrollTop`만 똑같이 맞추면 됨.
