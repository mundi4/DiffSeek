...
class DiffPostProcessor {
	...
	constructor(diffseek: DiffSeek, leftEditor: Editor, rightEditor: Editor, editorPairer: EditorPairer, diffOptions: DiffOptions, rawDiffs: RawDiff[]) {
		// this.#ctx = ctx;
		this.#diffseek = diffseek;
