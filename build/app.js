(function (jsxRuntime, client, React, clsx, jotai, reactSlot, dynamic, DropdownMenuPrimitive, ToggleGroupPrimitive, TogglePrimitive) {
  'use strict';
  ...
  class Renderer {
    ...
    #options = structuredClone(defaultRendererOptions);
    #leftRegion;
    #rightRegion;
    #canvasX = 0;
    #canvasY = 0;
  ...
  atomWithStorage("magnifierEnabled", true);
  jotai.atom(false);
  ...
  class DiffController {
    ...
    constructor(leftEditor, rightEditor, renderer, diffOptions = { ...defaultDiffOptions$1 }) {
      this.#leftEditor = leftEditor;
      this.#rightEditor = rightEditor;
      this.#renderer = renderer;
      this.#diffOptions = diffOptions;
  ...
  function DiffControllerProvider({ value, children }) {
    return /* @__PURE__ */ jsxRuntime.jsx(DiffControllerContext.Provider, { value, children });
  }
  ...
  const renderModeAtom = atomWithStorage("inlineDiffRenderMode", "stacked");
      ...
      if (leftRange && rightRange) {
        ...
        setTextPair((prev) => {
          ...
          if (leftText2.length <= MaxTextLength && rightText2.length <= MaxTextLength) {
            requestQuickDiff(leftText2, rightText2, diffOptions, (result) => setEntries(result));
          }
  ...
  function RenderSplitDiff(entries, leftText, rightText, dir = "row") {
    function build(text, key, typeFlags) {
      ...
      const flush = () => {
        ...
        out.push(
          /* @__PURE__ */ jsxRuntime.jsx("span", { className: diff({ type: currentType }), children: buffer.join("") }, ++spanIndex)
        );
        buffer = [];
      };
  ...
  const diffController = new DiffController(leftEditor, rightEditor, renderer, defaultDiffOptions);

  const diffOptionsAtom = jotai.atom(defaultDiffOptions);
  ...
  function ModeSelector({ value, onChange }) {
    return /* @__PURE__ */ jsxRuntime.jsxs(ToggleGroup, { variant: "default", type: "single", size: "xs", value, onValueChange: onChange, className: "", style: {
      "--accent": "var(--primary)",
      "--accent-foreground": "var(--primary-foreground)"
    }, children: [
  ...
  function App() {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx("div", { children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: clsx(appLayout), children: /* @__PURE__ */ jsxRuntime.jsxs(ResizablePanelGroup, { direction: "horizontal", children: [
      /* @__PURE__ */ jsxRuntime.jsx(ResizablePanel, { minSize: 400, children: /* @__PURE__ */ jsxRuntime.jsx(EditorPanel, {}) }, "main"),
      /* @__PURE__ */ jsxRuntime.jsx(ResizablePanel, { minSize: 170, initialSize: "250px", children: /* @__PURE__ */ jsxRuntime.jsx(AppSidebar, {}) }, "side")
    ] }) }) });
  }

  client.createRoot(document.getElementById("root")).render(
    /* @__PURE__ */ jsxRuntime.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntime.jsx(DiffControllerProvider, { value: { diffController, leftEditor, rightEditor, renderer }, children: /* @__PURE__ */ jsxRuntime.jsx(App, {}) }) })
  );

})(Vendor.ReactJSXRuntime, Vendor.ReactDOM, Vendor.React, Vendor.clsx, Vendor.jotai, Vendor.RadixUI.Slot, Vendor.VanillaExtractDynamic, Vendor.RadixUI.DropdownMenuPrimitive, Vendor.RadixUI.ToggleGroupPrimitive, Vendor.RadixUI.TogglePrimitive);
