...
class DiffSeek {
    ...
    setupEventListeners() {
        ...
        document.addEventListener("keydown", (e) => {
            if (e.key === "F8") {
                ...
                e.preventDefault();
                this.syncScroll = !this.#scrollSyncEnabled;
            }
    ...
    #onDiffVisibilityChanged(region, entries) {
        ...
        this.#anchorManager.update((amFn) => {
            ...
            for (let i = 0; i < rawEntries.length; i++) {
                ...
                if (rawEntry.type) {
                    ...
                    let leftAnchorFlags = 0 /* AnchorFlags.None */;
                    let rightAnchorFlags = 0 /* AnchorFlags.None */;
            ...
            function finalizeDiff() {
                ...
                if (leftTokenCount > 0 && rightTokenCount > 0) {
                    ...
                    let filledAnchorFlags = 0 /* AnchorFlags.None */;
                    let emptyAnchorFlags = 0 /* AnchorFlags.None */;
                    ...
                    // && filledEndFlags & TokenFlags.LINE_END
                        ...
                        emptyAnchorFlags = 128 /* AnchorFlags.EMPTY_DIFF */;
                    }
                    if (leftTokenCount > 0) {
    ...
    alignAnchors() {
        ...
        if (changed) {
            ...
            // force reflow.
            // 이게 실제로 자식들도 reflow를 시키는지 확인해 볼 필요가 있다. chatgpt는 된다고 하지만 믿음이 안가...
    ...
    setContent(editorName, contentHTML) {
        const editor = editorName === "left" ? this.#leftEditor : this.#rightEditor;
        editor.setContent(contentHTML);
    }
}
function findCommonEdgeContainer(lhsContainer, lhsTokenIndex, rhsContainer, rhsTokenIndex) {
