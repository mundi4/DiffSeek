...
export const en: Messages = {
    ...
    structuralOnlyMultipliersDesc: "Score multiplier for anchors with only structural tokens (comma-separated). index = matched token count",
    structuralLevelBonuses: "Structural Level Bonuses",
    structuralLevelBonusesDesc: "Bonus multiplier per structural level (comma-separated). index: 0=unused, 1=TD/TH, 2=TR, 3=TABLE",
