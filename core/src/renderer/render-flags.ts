...
export const RENDER_MINIMAP = DIRTY_GEOMETRY | DIRTY_RESIZE | DIRTY_DIFF_HIGHLIGHT | DIRTY_DIFF_HIGHLIGHT_OFFSCREEN;
...
export const RENDER_REGION_MASK = 0x7E0;
export const RENDER_REGION_SHIFT = 11 as const;
